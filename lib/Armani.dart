...
class Armani extends StatelessWidget {
  ...
  final urlImages = [
    'https://i.pinimg.com/originals/14/ff/43/14ff4392502fb593ada7a6b0bc2e2ea5.jpg',
    'https://st.kuponrazzi.com/images/kampanya/exxe-selection/exxe-4.jpg',
    'https://cdn.dribbble.com/users/1896468/screenshots/4273191/0400_giorgio_armani_marque_20s_81.gif'
  ];
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
            gradient: LinearGradient(
                ...
                colors: [Colors.grey, Colors.white.withOpacity(0.5)])),
