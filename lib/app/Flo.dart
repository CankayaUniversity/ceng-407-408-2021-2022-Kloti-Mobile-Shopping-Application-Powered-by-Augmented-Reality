...
class Flo extends StatelessWidget {
  ...
  final urlImages = [
    'https://www.tektelefon.com/wp-content/uploads/2016/11/flo-logo.png',
    'https://floimages.mncdn.com/media/catalog/product/img/content/21-08/02/default_ayakkabi_336x200.jpg',
    'https://pbs.twimg.com/media/Eg6Rv0cXgAEXYV8.jpg'
  ];
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
            gradient: LinearGradient(
                ...
                colors: [Colors.orangeAccent.withOpacity(0.3), Colors.orange])),
